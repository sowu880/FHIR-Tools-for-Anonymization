...
namespace Fhir.Anonymizer.Core.UnitTests.Processors
{
    public class DateShiftProcessorTests
    {
        ...
        public void GivenADateNode_WhenDateShift_DateShiftedNodeShouldBeReturned()
        {
            ...
            var processResult = processor.Process(node, new AnonymizerNodeProcessSetting("dateshift"));
            ...
            processResult = processor.Process(node, new AnonymizerNodeProcessSetting("dateshift"));
